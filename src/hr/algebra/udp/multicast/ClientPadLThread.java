...
public class ClientPadLThread extends Thread {
    ...
    public ClientPadLThread(Paddle paddle) {
...
//            //System.out.println("Quote of the Moment: " + received);            
                ...
                Logger.getLogger(ClientPadLThread.class.getName()).log(Level.SEVERE, null, ex);
